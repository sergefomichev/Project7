![alt text](<CleanShot 2026-06-11 at 13.32.47@2x.png>)

ROMPT TO RECREATE THIS LANDING PAGE
...
```css
@import
 url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Manrope:wght@300;400;500;600;700&display=swap');
@import
 "tailwindcss";
...
useEffect(() => {
  ...
  const handleScroll = () => {
    ...
    const absoluteTop = window.scrollY + http://rect.top;
